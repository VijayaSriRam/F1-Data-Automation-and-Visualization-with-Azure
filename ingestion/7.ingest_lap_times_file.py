...
# MAGIC %md
# MAGIC ##### Step-1: Read the CSV file using Spark DF Reader API
...
lap_times_ingestion = add_ingestion_date(lap_times_df)

# COMMAND ----------

lap_times_final_df = lap_times_ingestion.withColumnRenamed("driverId", "driver_id") \
